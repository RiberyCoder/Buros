        ...
        if contraseña.startswith("ENCRYPTED:"):
            try:
                ...
                if not os.path.exists(clave_privada_path):
                    global crear_clave_privada_con_contraseña
                    global serializar_y_guardar_clave_publica
                    ...
                    global cargar_clave_privada
                    global cargar_clave_publica
                    global cargar_encriptar_guardar_ini
